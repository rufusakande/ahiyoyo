export default function RegisterPage() {
      ...
      <div className="mt-7 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-neutral-900 dark:border-neutral-700">
        <div className="p-4 sm:p-7">
          <div className="text-center">
            <h1 className="block text-2xl font-bold text-gray-800 dark:text-white">S'inscrire</h1>
  ...
  required aria-describedby="password-error" />
                ...
                <div>
                  <label htmlFor="confirm-password" className="block text-sm mb-2 dark:text-white">Confirmez le mot de passe</label>
                  <div className="relative">
                ...
                <div className="flex items-center">
                  ...
                  <div className="ms-3">
                    <label htmlFor="remember-me" className="text-sm dark:text-white">J'accepte les <a className="text-primary decoration-2 hover:underline focus:outline-none focus:underline font-medium dark:text-primary" href="#">Termes et conditions</a></label>
                  </div>
                </div>

                <button type="submit" className="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-primary text-white hover:bg-yellow-500 focus:outline-none focus:ring-2 disabled:opacity-50 focus:ring-primary disabled:pointer-events-none">S'inscrire</button>
              </div>
            </form>
          </div>
        </div>
